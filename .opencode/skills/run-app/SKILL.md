---
name: run-app
description: Detect the local project type, check for required environment variables, and start or restart the app on localhost. Use when the user wants to run, start, or restart their local app.
---
