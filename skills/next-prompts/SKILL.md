---
name: next-prompts
description: Suggest 5 business-focused prompts to copy-paste into Claude Code. Use when the user wants ideas, next steps, or invokes /next-prompts.
user_invocable: true
---

# Next Prompts

Generate 5 prompts the user can copy-paste into Claude Code, focused on business, ideas, and UI/UX.
